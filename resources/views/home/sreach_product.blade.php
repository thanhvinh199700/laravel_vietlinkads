...
<div class="row text-center">
    <h3>Đã tìm thấy {{count($productSreach)}} sản phẩm thuộc </h3>
</div>
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="container-fluid">
            @foreach($productSreach as $productSreach)
                    ...
                    <div class="product-block-wp">
                        <div class="view view-fifth text-center">
                            ...
                            <div class="image-prod-list" style="margin-left: -16px;">
                                <a title="Kệ treo tường Entryway" href="/product/{{$productSreach->id}}">
                                    <img title="Kệ treo tường Entryway" src="{{$productSreach->image}}" alt="Kệ treo tường Entryway" width="150px;">
                                </a>
                            </div>
                        ...
                        <div class="description top-pro-cen ">
                            <div class="name-product">
                                <p style="font-size:14px;">
                                    <a href="">{{$productSreach->product_name}}</a>

                                </p>

                            </div>
                            <p class="product-price" style="color: #EC4282">₫&nbsp;{{number_format($productSreach->price)}}</p>
                            <img src="{{asset('images/star.png')}}" width="70px"><br />
                            @if($productSreach->quantity > 0)
                            <a class="concu btn btn-primary" href="#" data_product_id="{{$productSreach->id}}"style="text-decoration:none;color:yellow"><i class="fa fa-cart-plus">Đặt mua hàng</i></a>
                            @else

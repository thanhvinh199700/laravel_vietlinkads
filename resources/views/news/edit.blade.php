...
<form method=post  action= "">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputProductname" name="tittle" value='{{$news->tittle}}'>
        </div>
    </div>
    <div class="form-group row">
        <label for="inputProductname" class="col-sm-2 col-form-label">Short_Description</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputProductname" name="short_description" value='{{$news->short_description}}'>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputImage" name="avatar" value='{{$news->avatar}}'>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea name =content id=inputDetail rows=6 cols=80> {{$news->content}}</textarea>
        </div>
    </div>

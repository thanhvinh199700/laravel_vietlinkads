...
<form method=post  action= "" >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputMenuName" name="inputMenuName"placeholder="Nhập vào menu name">
        </div>
    </div>
     ...
     <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputLink" name="inputLink"placeholder="Nhập vào URL">
        </div>
    </div>
